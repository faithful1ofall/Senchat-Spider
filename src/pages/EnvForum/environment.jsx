...
const EnvForum = () => {
  ...
  return (
    <>
      {/* <Navbar className="flex fixed top-0 md:flex-col flex-row md:gap-5 items-center justify-center mb-0.5 md:px-5 w-full" /> */}
      <div className="bg-gray-100 flex sm:justify-center md:flex-col md:items-center flex-row-reverse font-prompt mx-auto relative w-full overflow-hidden">
        ...
        <Sidebar className="!sticky !w-[333px] bg-gray-100 flex h-screen justify-start mx-[20px] mt-[-16px] overflow-auto md:px-5 top-[0] z-[1]">
          <div className="bg-gray-100 flex flex-col items-center justify-end py-[31px] w-full"></div>
          <div className="bg-white-A700_cc flex flex-col gap-[26px] items-start justify-start mt-[57px] p-5 rounded-[10px] w-[333px]">
          ...
          <div className="h-[51px] md:h-[79px] mt-[29px] relative w-full">
