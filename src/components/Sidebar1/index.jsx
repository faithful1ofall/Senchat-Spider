  ...
  return (
    <>
      <Sidebar className={props.className}>
        <div className="bg-gray-100 h-[99px] w-full"></div>
        <Text
          className="bg-gray-100 h-[51px] justify-center md:ml-[0] ml-[59px] pb-3 sm:pr-5 pr-[35px] text-2xl md:text-[22px] text-black-900 sm:text-xl w-[333px]"
